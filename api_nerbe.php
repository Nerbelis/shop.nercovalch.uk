...
// Lógica de Nerbe para Nerco Valch
...
elseif (strpos($mensaje, 'mercancia') !== false || strpos($mensaje, 'catalogo') !== false || strpos($mensaje, 'productos') !== false || strpos($mensaje, 'otro') !== false) {
    $respuesta = "Más mercancía disponible:\nAdemás de franelas y gorras personalizadas, en Nerco Valch contamos con otros artículos especiales.\nEscríbenos al WhatsApp 0412-6526413 para enviarte fotos y detalles.";
} 
elseif (strpos($mensaje, 'hola') !== false || strpos($mensaje, 'info') !== false) {
    $respuesta = "¡Bienvenido a Nerco Valch (shop.nercovalch.uk)! Soy Nerbe, tu asistente virtual. ¿Qué deseas consultar hoy? Pregúntanos por precios, diseños personalizados, nuestra mercancía o el pago móvil.";
} 
else {
    $respuesta = "Entiendo tu consulta. Para darte más detalles personalizados o concretar tu pedido en Nerco Valch, escríbenos directamente a nuestro WhatsApp de empresa: 0412-6526413.";
}
